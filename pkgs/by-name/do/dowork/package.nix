...
let
  ...
  prepareWork = writeShellScriptBin "preparework" ''
  ...
  doWork = writeShellScriptBin "dowork" ''
    ${sourcePrepare}
  ...
  editWork = writeShellScriptBin "editwork" ''
    ${sourcePrepare}
  ...
  listWorks = writeShellScriptBin "listworks" ''
    ${sourcePrepare}
  ...
  flushWork = writeShellScriptBin "flushwork" ''
    ${sourcePrepare}
  ...
  workCompletion = name: writeTextDir "share/bash-completion/completions/${name}" ''
    ${sourcePrepare}
...
symlinkJoin {
  ...
  paths = [
    ...
    listWorks
    flushWork
    (workCompletion "dowork")
    (workCompletion "editwork")
    (workCompletion "flushwork")
  ];
}
